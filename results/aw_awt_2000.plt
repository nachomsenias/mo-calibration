...
set output 'spea2_moead_aw_awt_2000.png'
...
set title "Pareto front aw vs sales"
...
plot for [i=0:1] 'data05/SPEA2a/SimpleABMProblem/FUN'.i.'.tsv' title 'SPEA2a '.i with points ls i+1, \
	 for [i=0:2] 'data05/SPEA2b/SimpleABMProblem/FUN'.i.'.tsv' title 'SPEA2b '.i with points ls i+3, \
	 for [i=0:2] 'data05/SPEA2c/SimpleABMProblem/FUN'.i.'.tsv' title 'SPEA2c '.i with points ls i+6, \
	 for [i=0:1] 'data05/SPEA2d/SimpleABMProblem/FUN'.i.'.tsv' title 'SPEA2d '.i with points ls i+9, \
	 for [i=0:2] 'data06/MOEADc/SimpleABMProblem/FUN'.i.'.tsv' title 'MOEADc '.i with points ls i+11

#plot for [i=0:2] 'SPEA2b/SimpleABMProblem/FUN'.i.'.tsv' title 'b '.i with points ls i+3
#plot for [i=0:2] 'SPEA2c/SimpleABMProblem/FUN'.i.'.tsv' title 'c '.i with points ls i+6
#plot for [i=0:1] 'SPEA2d/SimpleABMProblem/FUN'.i.'.tsv' title 'd '.i with points ls i+9
