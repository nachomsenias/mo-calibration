...
set output 'wom_fitting_area_b4.png'
...
set multiplot
plot 'bestWOM/wom_area_b4.csv' u 1:2:3 w filledcurves notitle ls 11 
plot 'bestAW/wom_area_b4.csv' u 1:2:3 w filledcurves notitle ls 9
plot 'TradeOff/wom_area_b4.csv' u 1:2:3 w filledcurves notitle ls 10
#unset multiplot
plot 'bestWOM/wom_area_b4.csv' using 1:4 title "Best WOM" with linespoints ls 11 lw 2, \
	'TradeOff/wom_area_b4.csv' using 1:4 title "Trade Off" with linespoints ls 10 lw 2, \
	'bestAW/wom_area_b4.csv' using 1:4 title "Best Awareness" with linespoints ls 9 lw 2, \
	'bestWOM/wom_area_b4.csv' using 1:5 title "Target" with lines ls 1 lw 2 dashtype '---'
