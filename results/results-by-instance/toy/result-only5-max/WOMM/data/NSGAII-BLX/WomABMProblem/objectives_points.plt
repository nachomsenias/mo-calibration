...
set terminal png size 854,480 enhanced font 'Helvetica, Arial, sans-serif, 18' 
...
set xlabel "Awareness error (%)" # x-axis label
set ylabel "WOM Volume error (%)" # y-axis label
...
plot 'Objectives20.tsv' title 'Pareto frontier' with fsteps ls 20, \
	'Objectives20.tsv' using 1:2:0 notitle with points pointtype 7 black
