...
#unset multiplot
plot 'bestAW/wom_area_b1.csv' using 1:4 title "Best Awareness" with linespoints ls 9 lw 2, \
	'bestAW/wom_area_b1.csv' using 1:5 title "Target" with lines ls 1 lw 2 dashtype '---', \
	'bestWOM/wom_area_b1.csv' using 1:4 title "Best WOM" with linespoints ls 11 lw 2, \
	'TradeOff/wom_area_b1.csv' using 1:4 title "Trade Off" with linespoints ls 10 lw 2, \
	'bestAW/wom_area_b1.csv' using 1:4 title "Best Awareness" with linespoints ls 9 lw 2, \
	'bestWOM/wom_area_b1.csv' using 1:5 title "Target" with lines ls 1 lw 2 dashtype '---'
