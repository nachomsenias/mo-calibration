...
plot 'MOEAD/MWomABMProblem/Surface.tsv' title 'MOEAD' with points ls 3 pointtype 7, \
	'SPEA2-BLX/MWomABMProblem/Surface.tsv' title 'SPEA2' with points ls 1 pointtype 5, \
	'SMSEMOA/MWomABMProblem/Surface.tsv' title 'SMSEMOA' with points ls 6 pointtype 1, \
	'IBEA/MWomABMProblem/Surface.tsv' title 'IBEA' with points ls 7 pointtype 3, \
	'NSGAII-BLX/MWomABMProblem/Surface.tsv' title 'NSGAII' with points ls 2 pointtype 9, \
	'GWASFGA/MWomABMProblem/Surface.tsv' title 'GWASFGA' with points ls 4 pointtype 2, \
	'MOMBI2/MWomABMProblem/Surface.tsv' title 'MOMBI2' with points ls 5 pointtype 6, \
	'NELDER-MEAD/MWomABMProblem/Surface.tsv' title 'Nelder-Mead' with points ls 8, \
	'pseudooptimal.tsv' title 'Aggregated' with points ls 11 pointtype 10
