...
#unset multiplot
plot 'awareness_area_b1.csv' using 1:4 title "B1" with linespoints ls 11 lw 2, \
	'awareness_area_b2.csv' using 1:4 title "B2" with linespoints ls 10 lw 2, \
	'awareness_area_b3.csv' using 1:4 title "B3" with linespoints ls 9 lw 2, \
	'awareness_area_b4.csv' using 1:4 title "B4" with linespoints ls 8 lw 2, \
	'awareness_area_b5.csv' using 1:4 title "B5" with linespoints ls 7 lw 2, \
	'awareness_area_b6.csv' using 1:4 title "B6" with linespoints ls 6 lw 2, \
	'awareness_area_b7.csv' using 1:4 title "B7" with linespoints ls 5 lw 2, \
	'awareness_area_b8.csv' using 1:4 title "B8" with linespoints ls 4 lw 2
